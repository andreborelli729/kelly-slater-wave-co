...
<section className="ranchMobile">
        ...
        <div className="ranchMobileTextContainer">
           ...
           <Link to="/surf-ranch"> <button className="ranchMobileBtn">Surf Ranch</button></Link>
        </div>
...
export default HomeRanchMobile;